...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		...
		<span><a href="<?php echo e(route('home')); ?>">Home</a> > <a href="<?php echo e(route('get-thong-tin-ca-nhan',Auth::user()->id)); ?>">Thông Tin Cá Nhân</a> > <a href="<?php echo e(route('get-thong-tin-ca-nhan',Auth::user()->id)); ?>">Sửa Thông Tin Cá Nhân</a></span>
	</div>
</div>
...
<div class="wrapper wrapper-content  animated fadeInRight blog">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				<div class="container">
                    <form action="<?php echo e(route('post-sua-thong-tin-ca-nhan',Auth::user()->id)); ?>" method="post" enctype="multipart/form-data" role="form">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group mb-3 input-group-sm">
                                                    ...
                                                    <select class="form-control" id="sel1" name="mmc_deptid">
                                                        <option value="<?php echo e(Auth::user()->mmc_deptid); ?>"><?php echo e(Auth::user()->mmc_deptid); ?></option>
                                                    </select>
                                                </div>
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group mb-3 input-group-sm">
                                                    ...
                                                    <textarea class="form-control md-textarea" rows="2" name="mmc_position" minlength="3" autocomplete="off" value="<?php echo e(Auth::user()->mmc_position); ?>"><?php echo e(Auth::user()->mmc_position); ?></textarea>
                                                </div>
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mmc/MMC-system/resources/views/admin/GiangVien/CaNhan/SuaCN.blade.php ENDPATH**/ ?>
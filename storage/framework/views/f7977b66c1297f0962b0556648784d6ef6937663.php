<?php $__env->startSection('content'); ?>
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <span><a href="<?php echo e(route('home')); ?>">Home</a> > <a href="<?php echo e(route('get-thong-tin-ca-nhan',Auth::user()->id)); ?>">Thông Tin Cá Nhân</a></span>
        </div>
    </div>
    <div class="card-body">
        <a href="<?php echo e(route('get-sua-thong-tin-ca-nhan',Auth::user()->id)); ?>" class="btn btn-primary btn-sm" title="Sửa Thông Tin Cá Nhân">
            <i class=" fa fa-user" aria-hidden="true"></i> Sửa Thông Tin Cá Nhân
        </a>
        <a href="<?php echo e(route('get-doi-pass',Auth::user()->id)); ?>" class="btn btn-primary btn-sm " title="Đổi PassWord">
                ...
                <div class="w3-twothird">
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            ...
                            <div class="w3-container my-4">
                                <h4 class="w3-opacity"><b>- Mã bộ môn: </b><?php echo e(Auth::user()->mmc_deptid); ?></h4>
                            </div>
                            <div class="w3-container my-4">
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mmc/MMC-system/resources/views/admin/GiangVien/CaNhan/ThongTinCN.blade.php ENDPATH**/ ?>
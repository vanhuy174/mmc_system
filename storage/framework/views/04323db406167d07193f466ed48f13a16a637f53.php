                ...
                <div class="widget navy-bg no-padding">
                    <div class="p-m">
                        ...
                        <h3 class="font-bold no-margins" style="padding-left: 15px">
                            <?php echo e(\App\Http\Controllers\GiangVienController::count()); ?>
            ...
            <div class="col-lg-4 " style="padding-right: 0px">
                <div class="widget lazur-bg no-padding">
                    <div class="p-m">
                        ...
                        <h3 class="font-bold no-margins" style="padding-left: 15px">
                            <?php echo e(\App\Http\Controllers\Admin\mmc_ControllerStudent::count()); ?>
            ...
            <div class="col-lg-4">
                <div class="widget yellw-bg no-padding" >
                    <div class="p-m">
                        ...
                        <h3 class="font-bold no-margins" style="padding-left: 15px">
                            <?php echo e(\App\Http\Controllers\Admin\ClassController::count()); ?>

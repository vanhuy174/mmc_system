...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		...
		<span><a href="{{route('home')}}">Home</a> > <a href="{{route('canhan.show',Auth::user()->id)}}">Thông Tin Cá Nhân</a> > Sửa Thông Tin Cá Nhân</span>
	</div>
</div>
{{-- <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				...
				<div class="container">
                    <form action="{{route('canhan.update',Auth::user()->id)}}" method="post" enctype="multipart/form-data" role="form">
                        {{ method_field('PUT') }}
                        {{ csrf_field() }}
                        <div class="row">

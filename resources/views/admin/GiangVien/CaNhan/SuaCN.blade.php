...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		...
		<span><a href="{{route('home')}}">Home</a> > <a href="{{route('get-thong-tin-ca-nhan',Auth::user()->id)}}">Thông Tin Cá Nhân</a> > <a href="{{route('get-thong-tin-ca-nhan',Auth::user()->id)}}">Sửa Thông Tin Cá Nhân</a></span>
	</div>
</div>
{{-- <div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
...
<div class="wrapper wrapper-content  animated fadeInRight blog">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				<div class="container">
                    <form action="{{route('post-sua-thong-tin-ca-nhan',Auth::user()->id)}}" method="post" enctype="multipart/form-data" role="form">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-lg-2 mt-5">
                                <div class="text-cent">
                                    <div class="form-group" >
                                        @if (is_null(Auth::user()->mmc_avatar))
                                        ...
                                        @else
                                            <input hidden id="img" type="file" name="mmc_avatar" class="form-control hidden" onchange="changeImg(this)" >
                                            <img id="avatar" class="thumbnail" width="170px" src="/IMG/{{Auth::user()->mmc_avatar}}" >
                                        @endif
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group mb-3 input-group-sm">
                                                    ...
                                                    <select class="form-control" id="sel1" name="mmc_deptid">
                                                        <option value="{{Auth::user()->mmc_deptid}}">{{Auth::user()->mmc_deptid}}</option>
                                                    </select>
                                                </div>
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
                                                    ...
                                                    <input type="date" name="mmc_dateofbirth" class="form-control" data-format="dd/mm/yyyy" autocomplete="off" value="{{Auth::user()->mmc_dateofbirth}}">
                                                </div>
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
                                                ...
                                                <div class="input-group mb-3 input-group-sm">
                                                    ...
                                                    <input type="text" name="mmc_personalid" class="form-control" minlength="3" maxlength="15"  autocomplete="off" value="{{Auth::user()->mmc_personalid}}">
                                                </div>
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">Ngày cấp:</span>
                                                    </div>
                                                    <input type="date" name="mmc_dateofpid" class="form-control" data-format="dd/mm/yyyy"  autocomplete="off" value="{{Auth::user()->mmc_dateofpid}}">
                                                </div>
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group mb-3 input-group-sm">
                                                    ...
                                                    <input type="text" name="mmc_phone" minlength="3" maxlength="12" class="form-control" required autocomplete="off" value="{{Auth::user()->mmc_phone}}">
                                                </div>
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
                                                ...
                                                {{-- <div class="input-group mb-3 input-group-sm">
                                                    ...
                                                    <input type="text" name="password" minlength="3" class="form-control" required autocomplete="off" value="{{Auth::user()->password}}">
                                                </div> --}}
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">Dân tộc:</span>
                                                    </div>
                                                    <input type="text" name="mmc_religion" class="form-control" minlength="3" autocomplete="off" value="{{Auth::user()->mmc_religion}}">
                                                </div>
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">Tôn giáo:</span>
                                                    </div>
                                                    <input type="text" name="mmc_ethnic" class="form-control" minlength="3" autocomplete="off" value="{{Auth::user()->mmc_ethnic}}">
                                                </div>
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">Nơi Sinh:</span>
                                                    </div>
                                                    <textarea class="form-control md-textarea" rows="2" name="mmc_placeofbirth" minlength="3" placeholder="Số nhà, đường phố, thành phố, xóm, thôn, xã, huyện, tỉnh.." autocomplete="off" value="{{Auth::user()->mmc_placeofbirth}}">{{Auth::user()->mmc_placeofbirth}}</textarea>
                                                </div>
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">Quê quán:</span>
                                                    </div>
                                                    <textarea class="form-control md-textarea" rows="2" name="mmc_hometown" minlength="3" placeholder="Số nhà, đường phố, thành phố, xóm, thôn, xã, huyện, tỉnh.." autocomplete="off" value="{{Auth::user()->mmc_hometown}}">{{Auth::user()->mmc_hometown}}</textarea>
                                                </div>
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group mb-3 input-group-sm">
                                                    ...
                                                    <textarea class="form-control md-textarea" rows="2" name="mmc_position" minlength="3" autocomplete="off" value="{{Auth::user()->mmc_position}}">{{Auth::user()->mmc_position}}</textarea>
                                                </div>
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="input-group mb-3 input-group-sm">
                                                    ...
                                                    <input type="text" name="mmc_nameofjob" class="form-control" minlength="1" autocomplete="off" value="{{Auth::user()->mmc_nameofjob}}">
                                                </div>
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">Mã Ngạch: </span>
                                                    </div>
                                                    <input type="text" name="mmc_codeofjob" class="form-control" minlength="1" autocomplete="off" value="{{Auth::user()->mmc_codeofjob}}">
                                                </div>
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">Bậc lương:</span>
                                                    </div>
                                                    <input type="number" step="any" min="0" name="mmc_salarylevel" class="form-control" minlength="1"  autocomplete="off" value="{{Auth::user()->mmc_salarylevel}}">
                                                </div>
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group mb-3 input-group-sm">
                                                    ...
                                                    <input type="number" step="any" min="0" name="mmc_salaryposition" class="form-control" minlength="1" autocomplete="off" value="{{Auth::user()->mmc_salaryposition}}">
                                                </div>
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                    <div class="input-group mb-3 input-group-sm">
                                                        ...
                                                        <textarea class="form-control md-textarea" rows="2" name="mmc_degree" minlength="1" placeholder="TSKH, TS, ThS, cử nhân, kỹ sư, cao đẳng, trung cấp, sơ cấp, chuyên ngành..." autocomplete="off" value="{{Auth::user()->mmc_degree}}">{{Auth::user()->mmc_degree}}</textarea>
                                                    </div>
                                                    <div class="input-group mb-3 input-group-sm">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text">Ngoại ngữ:  </span>
                                                        </div>
                                                        <textarea class="form-control md-textarea" rows="2" name="mmc_language" minlength="1" placeholder="Tên ngoại ngữ + Trình độ A, B, C, D......" autocomplete="off" value="{{Auth::user()->mmc_language}}">{{Auth::user()->mmc_language}}</textarea>
                                                    </div>
                                                    <div class="input-group mb-3 input-group-sm">
                                                        <div class="input-group-prepend">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group mb-3 input-group-sm">
                                                    ...
                                                    <textarea class="form-control md-textarea" rows="2" name="mmc_politiclevel" minlength="1" autocomplete="off" value="{{Auth::user()->mmc_politiclevel}}">{{Auth::user()->mmc_politiclevel}}</textarea>
                                                </div>
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">Quản lý nhà nước: </span>
                                                    </div>
                                                    <textarea class="form-control md-textarea" rows="2" name="mmc_managementlevel" minlength="1" autocomplete="off" value="{{Auth::user()->mmc_managementlevel}}">{{Auth::user()->mmc_managementlevel}}</textarea>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="input-group mb-3 input-group-sm">
                                                    ...
                                                    <input type="date" name="mmc_partydate" class="form-control" data-format="dd/mm/yyyy" autocomplete="off" value="{{Auth::user()->mmc_partydate}}">
                                                </div>
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group mb-3 input-group-sm">
                                                    ...
                                                    <textarea class="form-control md-textarea" rows="2" name="mmc_reward" minlength="1" placeholder="Hình thức cao nhất, năm nào" autocomplete="off" value="{{Auth::user()->mmc_reward}}">{{Auth::user()->mmc_reward}}</textarea>
                                                </div>
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">Kỷ luật: </span>
                                                    </div>
                                                    <textarea class="form-control md-textarea" rows="2" name="mmc_discipline" minlength="1" placeholder="về đảng, chính quyền, đoàn thể hình thức cao nhất, năm nào" autocomplete="off" value="{{Auth::user()->mmc_discipline}}">{{Auth::user()->mmc_discipline}}</textarea>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="input-group mb-3 input-group-sm">
                                                    ...
                                                    <textarea class="form-control md-textarea" rows="2" name="mmc_heathlevel" minlength="1" autocomplete="off" value="{{Auth::user()->mmc_heathlevel}}">{{Auth::user()->mmc_heathlevel}}</textarea>
                                                </div>
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group mb-3 input-group-sm">
                                                    ...
                                                    <input type="number" step="any" min="0" name="mmc_tall" class="form-control" minlength="1" placeholder="m" autocomplete="off" value="{{Auth::user()->mmc_tall}}">
                                                </div>
                                                <div class="input-group mb-3 input-group-sm">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">Cân nặng: </span>
                                                    </div>
                                                    <input type="number" step="any" min="0" name="mmc_weight" class="form-control" minlength="1" placeholder="kg" autocomplete="off" value="{{Auth::user()->mmc_weight}}">
                                                </div>

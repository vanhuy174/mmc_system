							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="input-group mb-3 input-group-sm">
										...
										<input type="text" name="mmc_classid" class="form-control" autocomplete="off" required oninvalid="this.setCustomValidity('Không được để trống')" oninput="this.setCustomValidity('')"="required oninvalid="this.setCustomValidity('Không được để trống')" oninput="this.setCustomValidity('')""  value="{{$data['mmc_classid']}}">
									</div>
									<div class="input-group mb-3 input-group-sm">
										<div class="input-group-prepend">
